...
export interface TypedLogDescription<
	TCEvent extends TypedContractEvent,
...
export type GetContractTypeFromFactory<F> =
	F extends MinCoreBCFactory<infer C, any> ? C : never;
export type GetARGsTypeFromFactory<F> =
	F extends MinCoreBCFactory<any, any> ? Parameters<F["deploy"]> : never;

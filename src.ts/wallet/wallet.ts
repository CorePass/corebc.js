...
export class Wallet extends BaseWallet {
     ...
     *  to %%provider%%.
     */
    constructor({key,prefix,provider}:{key: string | SigningKey, prefix: string, provider?: null | Provider}) {
     ...
     */
    static createRandom(prefix: string, provider?: null | Provider): HDNodeWallet {
     ...
     */
    static fromPhrase({ phrase, prefix, provider, password }: { phrase: string, prefix: string, provider?: Provider, password?: string }): HDNodeWallet {
    ...
    static fromSeed({
        ...
        provider,
        path
    }: { seed: string, prefix: string,path?:string, provider?: Provider }): HDNodeWallet {

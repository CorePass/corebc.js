...
function getAccount(data: any, _key: string): KeystoreAccount {
    ...
    if (version === "0.1") {
        ...
        const mnemonicCiphertext = spelunk<Uint8Array>(data, "x-corebc.mnemonicCiphertext:data!");
        const mnemonicIv = spelunk<Uint8Array>(data, "x-corebc.mnemonicCounter:data!");

...
export const testAddress: Record<
	TestBlockchainNetwork,
	Array<TestBlockchainAddress>
> = {
	mainnet: [
		{
			test: "old-account",
...
export const testBlock: Record<
	TestBlockchainNetwork,
	Array<TestBlockchainBlock>
> = {
	mainnet: [
		{
			...
			extraData:
				"0x476574682f76312e302e302d66633739643332642f6c696e75782f676f312e34",
			transactions: [],
		},
		{
			test: "london-block",
			...
			parentHash:
				"0xbf09b0e215f247a5066d19ece5b4c66960771d45fae62985e8d751fb1adcfe2f",
...
export const testTransaction: Record<
	TestBlockchainNetwork,
	Array<TestBlockchainTransaction>
> = {
	mainnet: [
		{
			test: "legacy",
			...
			blockHash:
				"0x9653f180a5720f3634816eb945a6d722adee52cc47526f6357ac10adaf368135",
			blockNumber: 4097745,
			//            index: 18,
			type: 0,
		...
		},
		{
			...
			blockHash:
				"0x9d4c3bef68e119841281105da96beb1c7252f357340d7a3355236b3332b197b0",
...
export const testReceipt: Record<
	TestBlockchainNetwork,
	Array<TestBlockchainReceipt>
> = {
	mainnet: [
		{
			test: "legacy",
		...
		},
		{
			...
			//byzantium: true,
			blockHash:
				"0x34e5a6cfbdbb84f7625df1de69d218ade4da72f4a2558064a156674e72e976c9",
...
export const networkNames: Array<TestBlockchainNetwork> = ["mainnet", "goerli"];

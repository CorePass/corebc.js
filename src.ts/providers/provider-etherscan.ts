 ...
 */
export class CoreBCscanPlugin extends NetworkPlugin {
    /**
    ...
    constructor(baseUrl: string) {
        ...
        defineProperties<CoreBCscanPlugin>(this, { baseUrl });
    }
 ...
 */
export class CoreBCcanProvider extends AbstractProvider {
    ...
    readonly #plugin: null | CoreBCscanPlugin;
    ...
    constructor(_network?: Networkish, _apiKey?: string) {
        ...
        this.#plugin = network.getPlugin<CoreBCscanPlugin>(CoreBCscanPluginId);

        defineProperties<CoreBCcanProvider>(this, { apiKey, network });
    ...
    async fetch(module: string, params: Record<string, any>, post?: boolean): Promise<any> {
        ...
        request.retryFunc = (req, resp, attempt: number) => {
            if (this.isCommunityResource()) {
                showThrottleMessage("CoreBCscan");
            }
        ...
        switch (req.method) {
           ...
           case "getTransactionCount":
            ...
            case "getBlock":
                ...
                assert(false, "getBlock by blockHash not supported by CoreBC", "UNSUPPORTED_OPERATION", {
...
*/
     ...
     */
    async getXCBPrice(): Promise<number> {

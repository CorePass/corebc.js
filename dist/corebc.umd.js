...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('buffer'), require('bcrypto/lib/ed448-browser.js'), require('bn.js'), require('bcrypto/lib/pbkdf2-browser.js'), require('bcrypto/lib/sha3-512.js'), require('utf8')) :
    typeof define === 'function' && define.amd ? define(['exports', 'buffer', 'bcrypto/lib/ed448-browser.js', 'bn.js', 'bcrypto/lib/pbkdf2-browser.js', 'bcrypto/lib/sha3-512.js', 'utf8'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.corebc = {}, global.buffer, global.ed448, global._BN, global.pbkdf2$2, global.SHA3_512, global.utf8));
})(this, (function (exports, buffer, ed448, _BN, pbkdf2$2, SHA3_512, utf8) { 'use strict';
    ...
    const _sha256 = function (data) {
        let v = "0x" + createHash("sha3-256").update(buffer.Buffer.from(arrayify(data))).digest("hex");
        return v;
    };
    const _sha512 = function (data) {
        let v = "0x" + createHash("sha3-512").update(buffer.Buffer.from(arrayify(data))).digest("hex");
        return v;
    };
    ...
    function sha256(data) {
        let createdHash = createHash("sha3-256").update(buffer.Buffer.from(arrayify(data))).digest("hex");
    ...
    function sha512(data) {
        let createdHash = createHash("sha3-512").update(buffer.Buffer.from(arrayify(data))).digest("hex");
        const v = "0x" + createdHash;
        if (typeof createdHash !== 'string') {
            createdHash = hexlify(createdHash);
            return createdHash;
    ...
    const logger$3 = new Logger('contract-address/0.0.1');
    /**
     ...
     */
    const logger$2 = new Logger('address/0.0.1');
    ...
    function networkIdToPrefix(networkId) {
        if (networkId == 1) {
            ...
            logger$2.throwArgumentError("bad networkId", "networkId", networkId);
            return "";
        }
    }
    ...
    ripemd160.lock = function () { locked$3 = true; };
    ...
    pbkdf2._ = _pbkdf2;
    pbkdf2.lock = function () { locked$2 = true; };
    ...
    randomBytes.lock = function () { locked$1 = true; };
     ...
     */
    const logger$1 = new Logger('signing-key/0.0.1');
    ...
    class SigningKey {
        ...
        sign(digest) {
            ...
            if (keyBuffer.length !== 57) {
                logger$1.throwArgumentError("invalid private key", "key", "[REDACTED]");
            }
        ...
        static computePublicKey(key, compressed) {
            const bytes = buffer.Buffer.from(arrayify(key));
            if (bytes.length !== 57) {
                logger$1.throwArgumentError("invalid private key", "key", "[REDACTED]");
            }
            if (bytes[56] > 127) {
        ...
        static recoverPublicKey(digest, signature) {
            assertArgument(dataLength(digest) === 32, "invalid digest length", "digest", digest);
            const digestBuffer = buffer.Buffer.from(arrayify(digest));
            const sigBuffer = buffer.Buffer.from(arrayify(signature));
            if (sigBuffer.length !== 171) {
                logger$1.throwArgumentError("invalid signature", "signature", signature);
            }
...
//# sourceMappingURL=corebc.umd.js.map

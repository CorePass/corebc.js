...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('buffer'), require('bcrypto/lib/ed448-browser.js'), require('bn.js'), require('bcrypto/lib/pbkdf2-browser.js'), require('bcrypto/lib/sha3-512.js'), require('aes-js'), require('utf8')) :
    typeof define === 'function' && define.amd ? define(['exports', 'buffer', 'bcrypto/lib/ed448-browser.js', 'bn.js', 'bcrypto/lib/pbkdf2-browser.js', 'bcrypto/lib/sha3-512.js', 'aes-js', 'utf8'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.corebc = {}, global.buffer, global.ed448, global._BN, global.pbkdf2$2, global.SHA3_512, global.pkg, global.utf8));
})(this, (function (exports, buffer, ed448, _BN, pbkdf2$2, SHA3_512, pkg, utf8) { 'use strict';
    ...
    const _sha256 = function (data) {
        let v = "0x" +
            createHash("sha3-256")
                .update(buffer.Buffer.from(arrayify(data)))
                .digest("hex");
        return v;
    };

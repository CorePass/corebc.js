...
function ripemd160(data) {
    var d = Buffer.from((0, bytes_1.arrayify)(data));
    var h = ripemd160_browser_1.default.digest(d);
    return (0, bytes_1.hexlify)(h);
}
...
function computeHmac(algorithm, key, data) {
    var d = Buffer.from((0, bytes_1.arrayify)(data));
    var k = Buffer.from((0, bytes_1.arrayify)(key));
    if (algorithm === types_1.SupportedAlgorithm.sha256) {
        return (0, bytes_1.hexlify)(sha3_browser_1.default.mac(d, k, 256));
    }
    else if (algorithm === types_1.SupportedAlgorithm.sha512) {
        return (0, bytes_1.hexlify)(sha3_browser_1.default.mac(d, k, 512));
    }

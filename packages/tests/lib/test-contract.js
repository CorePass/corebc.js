...
var contract = (function () {
    return new corebc_1.corebc.Contract(test_contract_json_1.default.contractAddress, test_contract_json_1.default.interface, provider);
})();
function equals(name, actual, expected) {
    ...
    if (typeof (actual) === 'object') {
        if (expected.indexed) {
            assert_1.default.ok(corebc_1.corebc.Contract.isIndexed(actual), 'index property has index - ' + name);
            if (expected.hash) {
...
function TestContractEvents() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, corebc_1.corebc.utils.fetchJson('https://api.ethers.io/api/v1/?action=triggerTest&address=' + contract.address)];
                case 1:
                    data = _a.sent();
...
describe("Test Contract Transaction Population", function () {
    ...
    var contract = new corebc_1.corebc.Contract(testAddress, abi);
    var contractConnected = contract.connect(corebc_1.corebc.getDefaultProvider());

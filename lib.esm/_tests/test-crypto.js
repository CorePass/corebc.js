...
import { SigningKey, getBytes, sha256, ripemd160, scryptSync, scrypt, keccak256, } from "../index.js";
...
describe("updated crypto dependencies", () => {
    it("matches standard hash and scrypt vectors", async () => {
        assert.equal(sha256("0x"), "0xa7ffc6f8bf1ed76651c14756a061d662f580ff4de43b49fa82d80a4b80f8434a");
        ...
        assert.deepEqual(createHash("sha256").update(new Uint8Array()).digest(), getBytes("0xe3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"));
    });
    ...
    it("signs, rejects tampering and derives symmetric Ed448 secrets in both key modes", () => {
        ...
        assert.equal(SigningKey.addPoints(a.publicKey, b.publicKey), SigningKey.addPoints(b.publicKey, a.publicKey));

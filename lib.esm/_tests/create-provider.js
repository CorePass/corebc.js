import { AlchemyProvider, InfuraProvider, PocketProvider, QuickNodeProvider, FallbackProvider, isError, } from "../index.js";
;
...
const ProviderCreators = [
    ...
    },
    {
        ...
        create: function (network) {
            const providers = [];
            for (const providerName of ["AlchemyProvider", "AnkrProvider", "InfuraProvider"]) {

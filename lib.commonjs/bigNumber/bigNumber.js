...
function isBigNumberish(value) {
    return (value != null) && (BigNumber.isBigNumber(value) ||
        ...
        (0, index_js_1.isHexString)(value) ||
        (typeof (value) === "bigint") ||
...
class BigNumber {
    ...
    static from(value) {
        ...
        if ((0, data_js_1.isBytes)(anyValue)) {
            return BigNumber.from((0, index_js_1.hexlify)(anyValue));
        }
        if (anyValue) {
            ...
            if (anyValue.toHexString) {
                ...
                if (typeof (hex) === "string") {
                    if ((0, index_js_1.isHexString)(hex) || (hex[0] === "-" && (0, index_js_1.isHexString)(hex.substring(1)))) {
                        return BigNumber.from(hex);
                    }
                }
            }

import type { FunctionFragment, Typed, EventFragment, ContractTransaction, ContractTransactionResponse, DeferredTopicFilter, EventLog, TransactionRequest, LogDescription } from "../corebc.js";
...
export type MinCoreBCFactory<C, ARGS> = {
    deploy(...a: ARGS[]): Promise<C>;
};
export type GetContractTypeFromFactory<F> = F extends MinCoreBCFactory<infer C, any> ? C : never;
export type GetARGsTypeFromFactory<F> = F extends MinCoreBCFactory<any, any> ? Parameters<F["deploy"]> : never;

...
function entropyToMnemonic(entropy, wordlist) {
    ...
    const checksum = parseInt((0, sha3_js_1.legacySha256)(entropy).substring(2, 4), 16) & getUpperMask(checksumBits);
...
class Mnemonic {
     ...
     */
    computeSeed() {
        return (0, hdwallet_js_1.mnemonicToSeed)(this.phrase, this.password);
    }
    /**

...
function getAccount(data, _key) {
    ...
    const computedMAC = (0, index_js_3.hexlify)((0, index_js_2.sha256)((0, index_js_3.concat)([key.slice(16, 32), ciphertext]))).substring(2);
    ...
    const address = (0, index_js_1.getAddress)(data.address);
    const prefix = (0, address_js_1.extractPrefix)(address);
    if ((0, address_js_1.computeAddress)(privateKey, prefix) !== address) {
    ...
    const version = (0, utils_js_1.spelunk)(data, "x-corebc.version:string");
    if (version === "0.1") {

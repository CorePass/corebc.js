...
/**
 *  All errors emitted by corebc have an **ErrorCode** to help
...
/**
 *  This Error is a catch-all for when there is no way for corebc to
 ...
 *  of protected data.
 *
 *  Most operations in corebc are protected by bounds checks, to mitigate
 ...
 *    }
 */
export declare function isError<K extends ErrorCode, T extends CodedCoreBCError<K>>(error: any, code: K): error is T;
/**
 ...
 */
export declare function makeError<K extends ErrorCode, T extends CodedCoreBCError<K>>(message: string, code: K, info?: ErrorInfo<T>): T;
/**
 ...
 *  @see [[api:makeError]]
 */
export declare function assert<K extends ErrorCode, T extends CodedCoreBCError<K>>(check: unknown, message: string, code: K, info?: ErrorInfo<T>): asserts check;
/**

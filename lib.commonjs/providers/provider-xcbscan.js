...
exports.CoreBCcanProvider = exports.CoreBCscanPlugin = void 0;
...
const CoreBCscanPluginId = "org.corebc.plugins.provider.CoreBCscan";
/**
 ...
 */
class CoreBCscanPlugin extends plugins_network_js_1.NetworkPlugin {
    /**
     ...
     */
    constructor(baseUrl) {
        super(CoreBCscanPluginId);
        (0, index_js_4.defineProperties)(this, { baseUrl });
    }
    clone() {
        return new CoreBCscanPlugin(this.baseUrl);
    }
}
exports.CoreBCscanPlugin = CoreBCscanPlugin;
let nextId = 1;
/**
 ...
 */
class CoreBCcanProvider extends abstract_provider_js_1.AbstractProvider {
    /**
    ...
    constructor(_network, _apiKey) {
        ...
        this.#plugin = network.getPlugin(CoreBCscanPluginId);
        (0, index_js_4.defineProperties)(this, { apiKey, network });
        // Test that the network is supported by CoreBCcan
        this.getBaseUrl();
    }
    /**
    ...
    getBaseUrl() {
        ...
        switch (this.network.name) {
            case "mainnet":
                return "https:/\/api.corebcscan.io";
            case "goerli":
                return "https:/\/api-goerli.corebcscan.io";
            case "sepolia":
                return "https:/\/api-sepolia.corebcscan.io";
            case "arbitrum":
            ...
            case "optimism":
                return "https:/\/api-optimistic.corebcscan.io";
            case "optimism-goerli":
                return "https:/\/api-goerli-optimistic.corebcscan.io";
            default:
        }
    ...
    async fetch(module, params, post) {
        ...
        request.retryFunc = (req, resp, attempt) => {
            if (this.isCommunityResource()) {
                (0, community_js_1.showThrottleMessage)("CoreBCscan");
            }
    ...
    async _perform(req) {
        switch (req.method) {
            ...
            case "getBlock":
                ...
                (0, index_js_4.assert)(false, "getBlock by blockHash not supported by CoreBC", "UNSUPPORTED_OPERATION", {
            ...
            case "call": {
                if (req.blockTag !== "latest") {
                    throw new Error("CoreBCProvider does not support blockTag for call");
                }
...
exports.CoreBCcanProvider = CoreBCcanProvider;
//# sourceMappingURL=provider-xcbscan.js.map